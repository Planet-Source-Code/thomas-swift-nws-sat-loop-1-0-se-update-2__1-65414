...
Private Type PICTDESC
    ...
    Public MyImageWidth As Long
    Public MyImageHeight As Long
    ...
    End Sub
    Public Function GetImageSize(PicFile As String)
        Dim Img As Long
        ' Load the image
        ...
        GdipGetImageWidth Img, MyImageWidth
        GdipGetImageHeight Img, MyImageHeight
    End Function
